-- OAuth and Email Verification Database Upgrade
...
ADD COLUMN bio TEXT NULL AFTER last_name,
...
-- Add is_admin column if it doesn't exist (from previous upgrade)
ALTER TABLE users ADD COLUMN is_admin BOOLEAN DEFAULT FALSE AFTER is_premium;
